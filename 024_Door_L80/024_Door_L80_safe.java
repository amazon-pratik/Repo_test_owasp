...
// {fact rule=log-injection@v1.0 defects=0}
      ...
      default:
        ...
        // Sanitize action parameter to prevent log injection
        String sanitizedAction = action != null ? action.replaceAll("[\r\n\t]", "_") : "null";
        logger.warn("unknown action for door " + this.id + ": " + sanitizedAction);
